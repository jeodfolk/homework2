...
function display2_1() {
  var myanswer  = "Saiyan.dragonball would return undefined. Null == undefined returns true because they are loosely compared after being converted to the same type. Null === undefined returns false because they are strictly compared and are of different types" // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "An error would be returned because x is not defined. If deleted no errors will be generated" // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "The display style is set to none so they wont actually appear on the page" // TODO 2.5: Fill in Answer here
